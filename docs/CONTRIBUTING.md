...
> [Code of Conduct](https://github.com/pettarin/dolfin/blob/main/docs/CODE_OF_CONDUCT.md).
...
[GitHub Issues](https://github.com/pettarin/dolfin/issues).
...
- When reporting a defect, please state the browser and `dolfin` versions
  you are using, and the steps to reproduce your problem
  (e.g., the settings and sequence of actions, etc.).
...
- You read carefully this document and the
  [DEVELOPMENT](https://github.com/pettarin/dolfin/blob/main/docs/DEVELOPMENT.md)
  one.
...
- Your PR is from a fix branch or feature branch (ideally branched off
  ...
  following the
  [Branching And Versioning Policy](https://github.com/pettarin/dolfin/blob/main/docs/DEVELOPMENT.md#branching-and-versioning-policy).
