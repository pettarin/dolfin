# Dolfin Code of Conduct

Like the technical community as a whole,
the Dolfin team and community is made up of
...
This code of conduct applies to all spaces managed by the Dolfin project.
...
[dolfin@albertopettarin.it](mailto:dolfin@albertopettarin.it).
...
- **Be respectful.**
  ...
  Members of the Dolfin community should be respectful
  when dealing with other members as well as with people
  outside the Dolfin community.
...
- **When we disagree, try to understand why.**
  ...
  and Dolfin is no exception.
  It is important that we resolve disagreements and differing views constructively.
  Remember that we're different.
  The strength of Dolfin comes from its varied community,
...
[CONTRIBUTING](https://github.com/pettarin/dolfin/blob/main/docs/CONTRIBUTING.md)
document.
If that doesn't answer your questions, feel free to
[contact us](mailto:dolfin@albertopettarin.it).
