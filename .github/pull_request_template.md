...
This pull request addresses Issue #REPLACE_ID_HERE (get the ID from https://github.com/pettarin/dolfin/issues).

(Optional) The following screenshots/videos visually confirm the result: ...
